...
For the purpose of this project, there are two principles to guarantee efficiency, progressive design, and creativity:
...
4. As a side note, Proposed Recommendations published after the 15th of October should easily allow the W3C Advisory Committee to visualize the document using the new design of the following year. Note however that such new design may be tweaked until November 31st or rejected by the Director.
